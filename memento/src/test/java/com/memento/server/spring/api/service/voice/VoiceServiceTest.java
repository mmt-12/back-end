...
public class VoiceServiceTest extends IntegrationsTestSupport {
    ...
    void createPermanentVoice() {
        ...
        PermanentVoiceCreateServiceRequest request =
                PermanentVoiceCreateServiceRequest.of(name, fixtures.associate.getId(), file);
    ...
    void createPermanentVoiceWithNoAssociate() {
        ...
        PermanentVoiceCreateServiceRequest request = PermanentVoiceCreateServiceRequest.of("test voice", 0L, file);
    ...
    void createPermanentVoiceWithDuplicateName() {
        ...
        PermanentVoiceCreateServiceRequest request = PermanentVoiceCreateServiceRequest.of(duplicateName,
                fixtures.associate.getId(), file);
