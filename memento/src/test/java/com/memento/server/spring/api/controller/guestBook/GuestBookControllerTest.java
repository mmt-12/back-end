...
public class GuestBookControllerTest extends ControllerTestSupport {
	...
	@Test
	@DisplayName("자기 자신의 방명록은 작성할 수 없다")
	void createTextWithSameAssociateTest() throws Exception {
		// given
		Long communityId = 1L;
		Long associateId = 1L;
	...
	@Test
	@DisplayName("자기 자신의 방명록은 작성할 수 없습니다")
	void createBubbleWithSameAssociateTest() throws Exception {
		// given
		Long communityId = 1L;
		Long associateId = 1L;
