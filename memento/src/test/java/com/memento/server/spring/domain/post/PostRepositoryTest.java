...
import com.memento.server.spring.domain.comment.CommentRepositoryTest;
...
public class PostRepositoryTest extends IntegrationsTestSupport {
	...
	private Fixtures createFixtures() {
		...
		return new Fixtures(savedMember, savedCommunity, savedAssociate, savedEvent, savedMemory);
	}
}
